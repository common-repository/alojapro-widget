    ...
    <form name="frmEngine" action="[@action]" id="frmEngine" method="post">
        ...
        <div class="container-fluid advanced alojapro-widget-banner">
            <div class="row alojapro-widget-inner-banner">
                ...
                <div class="col-md-12 col-lg-3 mt-2 mb-2 alojapro-roomconfig" style="line-height: 1;">
                    <div class="input-group">
                        <input id="advanced-filters" name="to" type="text" placeholder="2 [@people_label], 1 [@room_label]" class="custom-input form-control" autocomplete="off" />
