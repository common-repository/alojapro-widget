<div class="alojapro-widget-plugin">
    <form name="frmEngine" action="[@action]" id="frmEngine" method="post">
        ...
        <div class="container-fluid advanced alojapro-widget-banner">
            <div class="row alojapro-widget-inner-banner">
                ...
                <div class="col-md-12 col-lg-2">
                    <div class="input-container back-white display-destinations">
                        <div class="input-group d-flex align-items-center position-relative">
                            <input id="destinations" type="button" value="[@button_destinations_label]" class="btn-discounts form-control custom-input form-control me-2 mr-2 me-2" data-bs-toggle="modal" data-bs-target="#alojaproDestinations_modal" />
                            <span class="btn-icon-primary"><i class="fa fa-hotel modern-hotel" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>

                <div class="col-md-12 col-lg-3 alojapro-checkin">
                    <div class="input-container back-white">
                        <div class="input-group d-flex align-items-center inputs">
                            <input id="from" name="from" type="text" placeholder="[@checkin_label]" class="datepicker widget_calendar form-control text-center me-2 mr-2 me-2" />
                            <span class="test-class d-flex align-items-center ms-0 me-0"><i class="fa fa-arrow-right" aria-hidden="true"></i></span>
                            <input id="to" name="to" type="text" placeholder="[@checkout_label]" class="datepicker widget_calendar form-control text-center me-2 mr-2 me-2" />
                            <span class="btn-icon-primary"><i class="fa fa-calendar modern-calendar" aria-hidden="true"></i></span>
                        </div>
                    </div>

                </div>
                <div class="col-md-12 col-lg-3 alojapro-roomconfig" style="line-height: 1;">
                    <div class="input-container back-white">
                        <div class="input-group d-flex align-items-center inputs">
                            <input id="advanced-filters" type="text" placeholder="2 [@people_label], 1 [@room_label]" class="custom-input form-control me-2 mr-2 me-2" />
                            <span class="btn-icon-primary"><i class="fa fa-user modern-user" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2">
                    <div class="input-container back-white display-discounts">
                        <div class="input-group d-flex align-items-center">
                            <input type="button" value="[@button_discounts_label]" class="btn-discounts form-control open-modal-alojapro-discounts custom-input form-control me-2 mr-2 me-2" />
                            <span class="btn-icon-primary"><i class="fa fa-percent modern-percent" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2">
        ...
        <!-- MODAL DESTINATIONS -->
        <div class="modal fade" id="alojaproDestinations_modal" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row room-options room-box"> 
                                ...
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="adults-select-1" class="form-control form-select" name="adults">
                                        [@adultDropDown]
                                    </select>
                                </div>
                                <!--room childs-->
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="child-1" class="form-control form-select me-2 mr-2" name="child-1">
                                        [@childDropDown]
                                    </select>
                                </div>
                                <!--childs ages-->
                            ...
                            <div class="row room-options room-box dnone"> 
                                ...
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="adults-select-2" class="form-control form-select" name="adults">
                                        [@adultDropDown]
                                    </select>
                                </div>
                                <!--room childs-->
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="child-2" class="form-control form-select  me-2 mr-2" name="child-2">
                                        [@childDropDown]
                                    </select>
                                </div>
                                <!--childs ages-->
                            ...
                            <div class="row room-options room-box dnone"> 
                                ...
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="adults-select-3" class="form-control form-select" name="adults">
                                        [@adultDropDown]
                                    </select>
                                </div>
                                <!--room childs-->
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="child-3" class="form-control form-select  me-2 mr-2" name="child-3">
                                        [@childDropDown]
                                    </select>
                                </div>
                                <!--childs ages-->
                            ...
                            <div class="row room-options room-box dnone"> 
                                ...
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="adults-select-4" class="form-control form-select" name="adults">
                                        [@adultDropDown]
                                    </select>
                                </div>
                                <!--room childs-->
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="child-4" class="form-control form-select  me-2 mr-2" name="child-4">
                                        [@childDropDown]
                                    </select>
                                </div>
                                <!--childs ages-->
                            ...
                            <div class="row room-options room-box dnone"> 
                                ...
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="adults-select-5" class="form-control form-select" name="adults">
                                        [@adultDropDown]
                                    </select>
                                </div>
                                <!--room childs-->
                                <div class="form-group col-md-3 col-sm-12 d-flex align-items-center mb-1">
                                    ...
                                    <select id="child-5" class="form-control form-select  me-2 mr-2" name="child-5">
                                        [@childDropDown]
                                    </select>
                                </div>
                                <!--childs ages-->
